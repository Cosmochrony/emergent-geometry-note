...
takes the metric established here as its starting point.
  ...
  \section{Logical Chain of the Sub-Programme}
    ...
    \begin{enumerate}
      ...
      Q5a-O2 closes hypotheses [H-E1] and Conjecture~[C] of the withdrawn framework via
      spectral atomicity, and H2 closes hypothesis~[H2] of the same framework; these closures
      retain independent interest but no longer establish the link.
  ...
  \section{Constituent Papers}
    ...
    \subsection{Continuum limit and one-dimensional shadow: Q5a and Q5a-O2}
      ...
      \emph{within the framework of Q5a versions up to 2.1}; after the version 3.0 withdrawal,
      these closures apply to components of the frozen framework [H-F] (Q9 version 1.1) and
      retain independent interest as structural facts about the admissible sector.
    ...
    \subsection{Effective spacetime output: Q6b}
      ...
      and its common scalar rescalings; the closures of [H-w] (W1) and of [H-E1] and [C]
      (Q5a-O2) apply to components of the withdrawn framework.
  ...
  \section{Status of Results}
    ...
    \subsection{Numerical evidence}
      ...
      \begin{enumerate}
        ...
        Closed analytically on the admissible sector by Q5a-O2 (within the withdrawn
        framework).
      \end{enumerate}
