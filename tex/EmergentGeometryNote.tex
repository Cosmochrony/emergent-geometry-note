...
\begin{document}
  ...
  \begin{abstract}
    ...
    across five internal phases, records the status of every result, and identifies the
    two remaining open items: bridge existence at finite $q$ and the open Q5a Mosco
    tightness hypotheses on the full function space.
  \end{abstract}
...
takes the metric established here as its starting point.
  ...
  \section{Logical Chain of the Sub-Programme}
    ...
    \begin{equation}
      ...
      \;\Longrightarrow\;
      \underbrace{\geff = 2\eta^{\mu\nu}}_{\substack{\text{metric closure} \\ \text{(Q8--Q11 + U1)}}}.
    \end{equation}
...
equations; those primary sources are Q5b and the Gravity paper respectively.
  ...
  \section{Inputs from Upstream Results}
    ...
    \begin{enumerate}
      ...
      The bounded-flux condition $A_n \leq c_\chi/\sqrt{\lambda_n}$ is the Q5a starting point.
